...
class EtamKawaTranslate {
  ...
  static Map<String, String> translateEn = {
    ...
    myCard: 'My Card',
    youJustEarnOneCompetency: 'You just earned one competency',
    pageArentReady: "This Page Aren't ready yet",
    comeBackLater:
        'We are still improving this page. Please come back any later soon',
    assigned: 'Assigned',
    ...
    submitted: 'Submitted',
    pleaseUploadYourEvidence: 'Please upload your evidence',
    pleaseWriteAndFillYourAnswer: 'Please write and fill your answer',
    allEntriesLoaded: 'All entries loaded.',
    noData: 'No data.',
    missionValidation: 'Mission Validation',
    giveAScore: 'Give a score',
    feedback: 'Feedback',
    ...
    willReceiveFeedbackShortly: 'The submitter will received feedback shortly',
    past: 'Past',
    view: 'View',
    focusBehaviour: 'Focus Behaviour',
    overallProgress: 'Overall Progress',
    chapterGoals: 'Chapter Goals',
    yes: 'Yes',
    no: 'No',
    next: 'Next',
    previous: 'Previous',
    ...
    leave: 'Leave',
    score: 'Score',
    chooseAScore: 'Choose a score',
    areYouSureWantToLeave: 'Are you sure want to leave?',
    writeYourAnswer: 'Write your answer here...',
    answerDetails: 'Answer Details',
    due: 'Due',
    yourAnswerIsCorrect: 'Your answer is correct!',
    yourAnswerIsInCorrect: 'Your answer is incorrect!',
    yourMissionHasBeenCompleted: 'Yeay, your mission has been completed!',
    ...
    areYouSureSubmitAssignment:
        'Are you sure want to to submit your assignment?',
    stay: 'Stay',
    progressSuccessfullySaved:
        "Progress successfully saved. We're saving your activity in this mission as a draft. Come back soon",
    evidence: 'Evidence (one file only)',
    yourMissionHasBeenSubmitted:
        'Your mission has been submitted and will be synced the nest time you are online',
    pleaseEnsure: 'Please ensure that your file is in the correct format.',
    dropYourFile: 'Drop your file here or click to upload',
  ...
  static Map<String, String> translateId = {
    ...
    duration: 'Durasi',
    days: 'Hari',
    submittedAt: 'Dikirimkan pada',
    submitted: 'Dikirim',
    pleaseUploadYourEvidence: 'Mohon unggah file',
    pleaseWriteAndFillYourAnswer: 'Mohon isi jawabanmu',
    validatedAt: 'Tervalidasi pada',
    allEntriesLoaded: 'Semua data dimuat.',
    noData: 'Tidak ada data.',
    missionValidation: 'Validasi Misi',
    giveAScore: 'Penilaian',
    feedback: 'Catatan penilaian',
    needImprovement: 'Kurang',
    fair: 'Cukup',
    good: 'Baik',
    excelent: 'Sangat baik',
    hooray: 'Hore !',
    feedbackSuccessfullySubmitted: 'Penilaian telah diberikan',
    willReceiveFeedbackShortly: 'dan akan segera diinformasikan kepada pemain',
    past: 'Riwayat',
    view: 'Lihat',
    focusBehaviour: 'Fokus Perilaku',
    overallProgress: 'Progress Tugas',
    chapterGoals: 'Tujuan Chapter',
    yes: 'Ya',
    no: 'Tidak',
    next: 'Selanjutnya',
    previous: 'Sebelumnya',
    ...
    leave: 'Keluar',
    score: 'Penilaian',
    chooseAScore: 'Pilih nilai',
    areYouSureWantToLeave: 'Kamu yakin ingin keluar?',
    writeYourAnswer: 'Tulis jawabanmu disini...',
    answerDetails: 'Rincian',
    due: 'Berakhir pada',
    yourAnswerIsCorrect: 'Jawabanmu tepat!',
    yourAnswerIsInCorrect: 'Jawabanmu belum tepat!',
    yourMissionHasBeenCompleted:
        'Selamat! Kamu telah berhasil menyelesaikan Misi!',
    backToMissionList: 'Kembali ke Misi',
    answerAssignment: 'Laporan',
    ...
    stay: 'Tidak',
    progressSuccessfullySaved:
        'Progresmu telah disimpan. Kamu dapat melanjutkan misi saat kembali.',
    evidence: 'Berkas (satu file)',
    yourMissionHasBeenSubmitted:
        'Kamu telah berhasil memproses misi dan akan terkirim saat kamu mendapatkan sinyal internet',
