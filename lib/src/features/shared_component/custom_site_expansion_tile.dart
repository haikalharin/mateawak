...
class ExpansionTileController {
  ...
  _CustomSiteExpansionTileState? _state;
  ...
  static ExpansionTileController of(BuildContext context) {
    final _CustomSiteExpansionTileState? result =
        context.findAncestorStateOfType<_CustomSiteExpansionTileState>();
    if (result != null) {
  ...
  static ExpansionTileController? maybeOf(BuildContext context) {
    return context
        .findAncestorStateOfType<_CustomSiteExpansionTileState>()
        ?._tileController;
  }
}
...
class CustomSiteExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with an expansion arrow icon that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const CustomSiteExpansionTile({
    super.key,
    this.expandIcon,
    this.collapseIcon,
    this.customCollapseIcon,
    this.widgetWithTrailing,
    this.useCustomIcon = false,
    this.isWithIcon = true,
    this.isWithPadding = true,
    this.isFullCustomTitle = false,
    required this.title,
    this.subtitle,
  ...
  @override
  State<CustomSiteExpansionTile> createState() =>
      _CustomSiteExpansionTileState();
}

class _CustomSiteExpansionTileState extends State<CustomSiteExpansionTile>
  ...
  Widget? _buildIcon(BuildContext context) {
    return Row(
      children: [
        widget.widgetWithTrailing ?? const SizedBox.shrink(),
        RotationTransition(
          turns: _iconTurns,
  ...
  Widget _buildChildren(BuildContext context, Widget? child) {
    ...
    return Container(
      ...
      decoration: widget.isWithPadding
          ? BoxDecoration(
          ...
          if (widget.isWithPadding) ...[
            ListTileTheme.merge(
              ...
              child: ListTile(
                ...
                leading: (_isExpanded
                        ? widget.expandIcon ?? _buildLeadingIcon(context)!
                        : widget.collapseIcon) ??
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(
                  mainAxisAlignment: widget.isFullCustomTitle
                      ? MainAxisAlignment.start
                      : MainAxisAlignment.spaceBetween,
                  children: [
                    widget.isFullCustomTitle
                        ? Expanded(child: widget.title)
                        : Row(
                            children: [
                              if (widget.isWithIcon) ...[
                                if (widget.useCustomIcon) ...[
                                  widget.customCollapseIcon ??
                                      _buildLeadingIcon(context)!,
                                ] else ...[
                                  (_isExpanded
                                          ? widget.expandIcon ??
